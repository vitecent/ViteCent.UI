<template>
	<section class="database-container">
		<h3 class="mb30">{{ $t('message.router.editDatabase') }}</h3>
				...
				<el-col :sm="24" :md="12" class="mb15">
					<el-form-item :label="$t('message.database.code')" prop="code">
						<el-input
							...
							:placeholder="$t('message.database.codePlaceholder')"
							maxlength="50"
							show-word-limit
							clearable
						></el-input>
				...
				<el-col :sm="24" :md="12" class="mb15">
					<el-form-item :label="$t('message.database.name')" prop="name">
						<el-input
							...
							:placeholder="$t('message.database.namePlaceholder')"
							maxlength="50"
							show-word-limit
							clearable
						></el-input>
				...
				<el-col :sm="24" :md="12" class="mb15">
					<el-form-item :label="$t('message.database.server')" prop="server">
						<el-input
							...
							:placeholder="$t('message.database.serverPlaceholder')"
							maxlength="50"
							show-word-limit
							clearable
						></el-input>
				...
				<el-col :sm="24" :md="12" class="mb15">
					<el-form-item :label="$t('message.database.port')" prop="port">
						<el-input
							...
							:placeholder="$t('message.database.portPlaceholder')"
							maxlength="50"
							show-word-limit
							clearable
						></el-input>
				...
				<el-col :sm="24" :md="12" class="mb15">
					<el-form-item :label="$t('message.database.user')" prop="user">
						<el-input
							...
							:placeholder="$t('message.database.userPlaceholder')"
							maxlength="50"
							show-word-limit
							clearable
						></el-input>
