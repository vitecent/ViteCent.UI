				...
				<el-col :sm="24" :md="12" class="mb15">
					<el-form-item :label="$t('message.table.code')" prop="code">
						<el-input
							...
							:placeholder="$t('message.table.codePlaceholder')"
							maxlength="50"
							show-word-limit
							clearable
						></el-input>
				...
				<el-col :sm="24" :md="12" class="mb15">
					<el-form-item :label="$t('message.table.name')" prop="name">
						<el-input
							...
							:placeholder="$t('message.table.namePlaceholder')"
							maxlength="50"
							show-word-limit
							clearable
						></el-input>
				...
				<el-col :sm="24" :md="12" class="mb15">
					<el-form-item :label="$t('message.table.server')" prop="server">
						<el-input
							...
							:placeholder="$t('message.table.serverPlaceholder')"
							maxlength="50"
							show-word-limit
							clearable
						></el-input>
				...
				<el-col :sm="24" :md="12" class="mb15">
					<el-form-item :label="$t('message.table.port')" prop="port">
						<el-input
							...
							:placeholder="$t('message.table.portPlaceholder')"
							maxlength="50"
							show-word-limit
							clearable
						></el-input>
				...
				<el-col :sm="24" :md="12" class="mb15">
					<el-form-item :label="$t('message.table.user')" prop="user">
						<el-input
							...
							:placeholder="$t('message.table.userPlaceholder')"
							maxlength="50"
							show-word-limit
							clearable
						></el-input>
