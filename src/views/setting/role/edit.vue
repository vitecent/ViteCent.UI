			...
			<el-row :gutter="10">
				<el-col :md="12" class="mb15">
					<el-form-item :label="$t('message.role.type')" prop="type">
						<el-input v-model="state.form.type" :placeholder="$t('message.role.typePlaceholder')" maxlength="50" show-word-limit clearable />
					</el-form-item>
				</el-col>
				<el-col :md="12" class="mb15">
				...
				<el-col :md="12" class="mb15">
					<el-form-item :label="$t('message.role.charSet')" prop="charSet">
						<el-input v-model="state.form.charSet" :placeholder="$t('message.role.charSetPlaceholder')" maxlength="50" show-word-limit clearable />
					</el-form-item>
				</el-col>
				<el-col :md="12" class="mb15">
		...
		if (valid) {
			api
				...
				.then((res) => {
					...
					if (state.flag) router.push({ name: 'settingRole' });
					else initData();
				})
				.catch((error) => {});
		} else {
