<template>
	<section class="role-container">
		<h3 class="mb30">{{ $t('message.router.editRole') }}</h3>
			...
			<el-row :gutter="10">
				...
				<el-col :sm="24" :md="12" class="mb15">
					<el-form-item :label="$t('message.role.code')" prop="code">
						<el-input v-model="state.form.code" :placeholder="$t('message.role.codePlaceholder')" maxlength="50" show-word-limit clearable></el-input>
					</el-form-item>
				</el-col>
				<el-col :sm="24" :md="12" class="mb15">
					<el-form-item :label="$t('message.role.name')" prop="name">
						<el-input v-model="state.form.name" :placeholder="$t('message.role.namePlaceholder')" maxlength="50" show-word-limit clearable></el-input>
					</el-form-item>
				</el-col>
				<el-col :sm="24" :md="12" class="mb15">
				...
				<el-col :sm="24" :md="12" class="mb15">
					<el-form-item :label="$t('message.role.server')" prop="server">
						<el-input
							...
							:placeholder="$t('message.role.serverPlaceholder')"
							maxlength="50"
							show-word-limit
							clearable
						></el-input>
				...
				<el-col :sm="24" :md="12" class="mb15">
					<el-form-item :label="$t('message.role.port')" prop="port">
						<el-input v-model="state.form.port" :placeholder="$t('message.role.portPlaceholder')" maxlength="50" show-word-limit clearable></el-input>
					</el-form-item>
				</el-col>
				<el-col :sm="24" :md="12" class="mb15">
					<el-form-item :label="$t('message.role.user')" prop="user">
						<el-input v-model="state.form.user" :placeholder="$t('message.role.userPlaceholder')" maxlength="50" show-word-limit clearable></el-input>
					</el-form-item>
				</el-col>
				<el-col :sm="24" :md="12" class="mb15">
