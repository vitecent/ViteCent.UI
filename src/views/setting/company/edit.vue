<template>
	<section class="company-container">
		<h3 class="mb30">{{ $t('message.router.editCompany') }}</h3>
				...
				<el-col :sm="24" :md="12" class="mb15">
					<el-form-item :label="$t('message.company.code')" prop="code">
						<el-input
							...
							:placeholder="$t('message.company.codePlaceholder')"
							maxlength="50"
							show-word-limit
							clearable
						></el-input>
				...
				<el-col :sm="24" :md="12" class="mb15">
					<el-form-item :label="$t('message.company.name')" prop="name">
						<el-input
							...
							:placeholder="$t('message.company.namePlaceholder')"
							maxlength="50"
							show-word-limit
							clearable
						></el-input>
				...
				<el-col :sm="24" :md="12" class="mb15">
					<el-form-item :label="$t('message.company.server')" prop="server">
						<el-input
							...
							:placeholder="$t('message.company.serverPlaceholder')"
							maxlength="50"
							show-word-limit
							clearable
						></el-input>
				...
				<el-col :sm="24" :md="12" class="mb15">
					<el-form-item :label="$t('message.company.port')" prop="port">
						<el-input
							...
							:placeholder="$t('message.company.portPlaceholder')"
							maxlength="50"
							show-word-limit
							clearable
						></el-input>
				...
				<el-col :sm="24" :md="12" class="mb15">
					<el-form-item :label="$t('message.company.user')" prop="user">
						<el-input
							...
							:placeholder="$t('message.company.userPlaceholder')"
							maxlength="50"
							show-word-limit
							clearable
						></el-input>
