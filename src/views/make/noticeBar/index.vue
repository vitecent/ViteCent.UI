	...
	<div class="notice-bar-container layout-pd">
		<el-card shadow="hover" header="滚动通知栏：默认">
			<NoticeBar
				...
				的后台开源免费模板库（vue2.x请切换vue-prev-admin分支），仓库地址：https://gitee.com/ViteCent/ViteCent"
			/>
		</el-card>
...
const state = reactive({
	noticeList: [
		...
		'仓库地址：https://gitee.com/ViteCent/ViteCent',
		'演示地址：https://ViteCent.gitee.io/ViteCent-preview/#/login',
	],
	tableData: [
		{
			a1: 'mode',
